...
use nrf52820_s140_firmware::ble::gatt_state::{AdvertisingState, ModemState, ServiceType, StateError};
...
mod tests {
    ...
    fn test_uuid_base_registration() {
        ...
        let uuid_base = [
            0x9e, 0x73, 0x12, 0xe0, 0x23, 0x54, 0x11, 0xeb, 0x9f, 0x10, 0xfb, 0xc3, 0x0a, 0x62, 0xcf, 0x38,
        ];
